    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Create Facilities</h4>
            ...
            <div class="py-12">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div>
                        ...
                        @endif
                        <form class="w-full" action="{{ route('facilities.store') }}" method="post">
                            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-8">
                                                    ...
                                                    <div class="card-action">
                                                        ...
                                                        <a href="/dashboard/facilities" class="btn btn-danger" on>Cancel</a>
